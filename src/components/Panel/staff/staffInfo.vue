  ...
  <div id="info-table">
    ...
    <div id="function-bar">
      <div id="operation-bar">
        <button class="btn btn-success" @click="getAllResidentInfo">全部员工</button>
        <button class="btn btn-primary" data-toggle="modal" data-target="#addResidentModal">新增员工</button>
      </div>
